...
if [ $? != 0 ]
 then
    ...
    tmux new-window -n programming -c /mnt/NAS/data/git/learning/rust/rustlings \; split-window -h -c /mnt/NAS/data/git/learning/rust/rustlings \; split-window -v -c /mnt/NAS/data/git/learning/rust/rustlings
